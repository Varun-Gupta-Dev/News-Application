...
import com.example.newsapplication.util.Costants.Companion.QUERY_PAGE_SIZE
import com.example.newsapplication.util.Costants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            // Retrieves linear layout manager from recycler view
